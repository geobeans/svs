...
void Font::Glyph::subload() const
{
    ...
    {
        osg::notify(osg::WARN)<<"before Font::Glyph::subload(): detected OpenGL error '"<<errorNo<<std::endl;
    }
    ...
    if (errorNo!=GL_NO_ERROR)
    {
        ...
        osg::notify(osg::WARN)<<"after Font::Glyph::subload() : detected OpenGL error '"<<errorNo<<"'"<<std::endl;
